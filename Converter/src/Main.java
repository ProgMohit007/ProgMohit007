...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        convertButton.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    .addComponent(resetButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(convertButton, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
                .addGap(43, 43, 43))
        );
    ...
    boolean check() {
        int i = 0;
        if ((binaryInput.getText()).compareTo(NULL) != 0) {
            i++;
        }
        if ((octalInput.getText()).compareTo(NULL) != 0) {
            i++;
        }
        if ((decimalInput.getText()).compareTo(NULL) != 0) {
            i++;
        }
        if ((hexaInput.getText()).compareTo(NULL) != 0) {
            i++;
        }
        if (i > 1) {
            JOptionPane.showMessageDialog(null, "Multiple input Not Allowed!!", "Error", JOptionPane.ERROR_MESSAGE);
            resetButton.doClick();
            return false;
        }
        return true;
    ...
    void compare() {
        ...
        String decimal = decimalInput.getText();
        String hexaDecimal = hexaInput.getText();

        if (binary.compareTo(NULL) != 0) {
        ...
        if (hexaDecimal.compareTo(NULL) != 0) {
    ...
    private void convertButtonKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_convertButtonKeyPressed
        eventHandle(evt);
    }//GEN-LAST:event_convertButtonKeyPressed
